...
const newPrediction = (seed)=>{
    console.log(seed, 'newPrediction');
...
const swipeable = ()=>{
    ...
    document.querySelector('.card.active').addEventListener('touchstart', startSwipe);
    document.querySelector('.card.active').addEventListener('touchend', stopSwipe);
